...
public class EmpCommunityNoticeController {
	...
	public String noticeList(
		...
		model.addAttribute("loggedInEmpUsername", empUsername);
	...
	public String noticeModForm(
		...
		model.addAttribute("loggedInEmpUsername", getCurrentEmpUsername());
	...
	public String noticeMod(
        ...
        try {
        	CommunityNoticeVO originalNotice = noticeService.selectNotice(comuNotiNo);
