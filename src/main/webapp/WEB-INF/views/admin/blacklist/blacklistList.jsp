...
<!-- 검색부분 -->
                        <div class="ea-header-actions">
                        	<form class="input-group input-group-sm" method="get" id="searchForm" style="flex-wrap: nowrap; ">
	                            ...
	                            <select id="searchCode" name="searchCode" class="ea-filter-select" title="상태 필터" style="width:70px; min-width: 75px;">
                            	...
                            	<input type="search" class="ea-search-input" name="searchWord" id="blacklistSearchInput" placeholder="회원 검색" style="width:150px;" value="${searchWord }">&nbsp;
